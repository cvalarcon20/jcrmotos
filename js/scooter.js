...
function getProductsScooterDb() {
   const url = "./json/dbMotosScooters.json";
...
async function loadProductsScooter(){
const products = await getProductsScooterDb();
...
$("body").prepend('<h5>Motos - Scooters</h5>');
