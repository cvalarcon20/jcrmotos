...
function getProductsTourDb() {
   const url = "./json/dbMotosTouring.json";
...
async function loadProductsTour(){
const products = await getProductsTourDb();
...
$("body").prepend('<h5>Motos - Touring</h5>');
