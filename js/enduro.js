...
function getProductsEnduroDb() {
   const url = "./json/dbMotosEnduro.json";
...
async function loadProductsEnduro(){
const products = await getProductsEnduroDb();
...
$("body").prepend('<h5>Motos - Enduro</h5>');
